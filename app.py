...
if st.session_state['page3']:
    ...
    instructions, titles, ingredients = [], [], []
    instructions1, titles1, ingredients1, scores = [], [], [], []  ##<==== changed the variables a bit so the variables below will not be affected
...
#         title, ing, instruction = get_recipe_info(recipe)

#         # contents = recipe instructions
#         instructions1.append(instruction) # content = from get_recipe_info func
#         # ingredients = recipe ingredients
#         ingredients1.append(ing) # ing = from get_recipe_info func
#         # titles = recipe titles
#         titles1.append(title) #
#         scores.append(model.predict_proba([instruction])[0][1])
#         # evaluate the recipe generated by chatgpt and output the final recipes
#     recipe_dict = {'title': titles1, 'ingredients': ingredients1, 'instructions': instructions1}
...
#     instructions.append(final_recipe["Instructions"])
...
# #######################
    ...
    st.session_state['instructions'] = instructions[0]
